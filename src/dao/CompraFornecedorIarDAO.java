...
import bean.CompraFornecedorIar;
 ...
 * @author u08439411111
 */
public class CompraFornecedorIarDAO extends DAO_Abstract {
    ...
    public Object list(int id) { //aqui o parâmetro
       session.beginTransaction(); // comecei uma transaçao
        Criteria criteria = session.createCriteria(CompraFornecedorIar.class); // Criteria é uma classe do hibernate para fazer consultas, to criando ela
    ...
    public ArrayList listAll() {
        session.beginTransaction();
        Criteria criteria = session.createCriteria(CompraFornecedorIar.class);
