...
public class JDlgVendasZhtPesquisar extends javax.swing.JDialog {
     ...
     */
    public JDlgVendasZhtPesquisar(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDlgVendasZhtPesquisar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDlgVendasZhtPesquisar dialog = new JDlgVendasZhtPesquisar(new javax.swing.JFrame(), true);
